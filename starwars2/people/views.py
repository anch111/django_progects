...
def get_luke_data(request):
    ...
    return render(request, 'people/luke_skywalker.html', data)
...
def get_people_list(request):
    ...
    for key, value in data.items():
        ...
        data_buff['model'] = value['model']
        data_buff['manufacturer'] = value['manufacturer']
...
def get_character_data(request, id):
    data = read_data()
    data = data[str(id)]
    return render(request, 'people/luke_skywalker.html', data)